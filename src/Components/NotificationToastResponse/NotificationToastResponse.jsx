...
const NotificationToastResponse = () => {
  const { popupNotification, setPopupNotification } = useNotificationStore();
  ...
  return (
    <div
      className={`toast position-fixed bottom-0 end-0 me-3 mb-3 p-0 border-0 fade show shadow-lg rounded-4 overflow-hidden z-3 ${
        popupNotification ? "show" : "hide"
      }`}
      role="alert"
      aria-live="assertive"
      aria-atomic="true"
    ...
    >
      <div className="p-3">
        ...
        <div className="d-flex justify-content-between align-items-center">
          ...
          <NavLink
            to={`/ticket/${popupNotification.ticketId}`}
