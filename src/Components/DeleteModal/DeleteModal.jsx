const DeleteModal = ({setShowModal, deleteHandler, selectedItemId, selectedItemContent, title, message }) => {
    ...
    return (
        ...
        >
            <div className="d-flex flex-column gap-2 bg-white rounded-3 shadow p-4 m-2" style={{maxWidth:'500px'}}>
                ...
                <div className="fw-bold f-size-14 text-truncate" style={{ maxWidth: "200px" }}>{selectedItemContent}</div>
