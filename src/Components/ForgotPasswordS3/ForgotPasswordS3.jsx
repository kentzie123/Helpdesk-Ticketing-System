...
const Forgot3 = () => {
  const { resetPassword, isRessetingPassword } = useForgotPasswordStore();
  ...
  const handleChangePassword = async (e) => {
    ...
    const resetPasswordSuccess = await resetPassword(password);
  ...
  return (
    <div className="vh-100 d-flex align-items-center justify-content-center flex-column">
      ...
      >
        ...
        >
          {isRessetingPassword ? "Saving..." : "Change Password"}
        </button>
