...
const Users = () => {
  const { users, getUsers, setSelectedUser, setShowDeleteUserModal, showDeleteUserModal, selectedUser, deleteUser } =
    useUserStore();
  ...
  const totalStaff = useMemo(() => {
    return users.filter((user) => user.roleName === "Staff").length;
  }, [users]);

  const totalClient = useMemo(() => {
    return users.filter((user) => user.roleName === "Client").length;
  }, [users]);
    ...
    <div className="p-2">
        ...
        <div className="row border rounded shadow-sm py-4 px-3">
          <div className="col-12 col-md-5 position-relative">
            ...
            <input
              ...
              type="text"
              className="form-control ps-5 f-size-14"
                  ...
                  <ul className="dropdown-menu w-100">
                    <li>
                      <a
                        ...
                        onClick={() =>
                          setUserFilters({ ...userFilters, role: "All Roles" })
                        }
                      >
                        All Roles
                      </a>
                    ...
                    <li>
                      <a
                        className="dropdown-item"
                        onClick={() =>
                          setUserFilters({ ...userFilters, role: "Admin" })
                        }
                      >
                        Admin
                      </a>
                    ...
                    <li>
                      <a
                        className="dropdown-item"
                        onClick={() =>
                          setUserFilters({ ...userFilters, role: "Staff" })
                        }
                      >
                        Staff
                      </a>
                    ...
                    <li>
                      <a
                        className="dropdown-item"
                        onClick={() =>
                          setUserFilters({ ...userFilters, role: "Client" })
                        }
                      >
                        Client
                      </a>
      ...
      {showDeleteUserModal && (
        <DeleteModal
          ...
          title={"Delete User"}
          message={
            "Are you sure you want to delete this user? This will permanently remove the user."
          }
      ...
      <div className="row mt-4">
        <div className="col-12 col-lg-4">
          <div className="d-flex align-items-center gap-3 p-4 border shadow-sm rounded-3">
            <div
              className="d-flex align-items-center justify-content-center rounded-3 bg-primary-subtle"
        ...
        <div className="col-12 col-lg-4">
          <div className="d-flex align-items-center gap-3 p-4 border shadow-sm rounded-3">
            <div
              className="d-flex align-items-center justify-content-center rounded-3 bg-violet-subtle"
              style={{ height: "48px", width: "48px" }}
            >
      ...
      <div className="mt-4 border rounded shadow-sm p-4">
        ...
        <table className="users-table table mt-4">
          <thead>
            <tr className="p-4">
              <th scope="col" className="text-muted fw-medium f-size-14">
                Name
              </th>
              <th scope="col" className="text-muted fw-medium f-size-14">
                Email
                ...
                <tr key={idx} className="p-4">
                  ...
                  <td>
                    <div
                      ...
                      } badge rounded-pill f-size-12 fw-medium text-center px-2`}
                    >
                      {user.roleName}
                    </div>
                  </td>
